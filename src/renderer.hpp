...
void render_object(node *object, glm::mat4 view, glm::mat4 proj) {
    for (mesh_t mesh : object->get_geometries()) {
        ...
        // Set matrices
        glUniformMatrix4fv(glGetUniformLocation(mesh.material->shader_program, "model"), 1, GL_FALSE, &object->get_global_transformation()[0][0]);
